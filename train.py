...
if __name__ == '__main__':
    ...
    parser.add_argument("--image_path", type=str, default='./dataset/train/image/', help="path to load training image")
    parser.add_argument("--mask_path", type=str, default='./dataset/train/mask/', help="path to load training masks")
    parser.add_argument("--val_image", type=str, default="./dataset/test", help="path to load validation image")
    parser.add_argument("--val_mask", type=str, default="./dataset/test/MDvsFA/mask", help="path to load validation masks")
    parser.add_argument("--bboxfile", type=str, default="./dataset/training_box_gt.csv", help="path to bounding boxes ground truth")
