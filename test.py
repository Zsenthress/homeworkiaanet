...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_image", type=str, default="./dataset/test/MDvsFA/image/", help="path to load testing image")
    parser.add_argument("--test_mask", type=str, default="./dataset/test/MDvsFA/mask/", help="path to load testing masks")
    parser.add_argument('--weights', type=str, default="./outputs/demo/best.pt", help="path of the weights")
